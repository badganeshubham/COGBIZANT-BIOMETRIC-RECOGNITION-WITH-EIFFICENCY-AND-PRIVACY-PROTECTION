...
<div class="main">
  <div class="header">
    ...
    <div class="headert_text_resize"> <img src="images/dataowner.jpg" alt="" width="395" height="295" style="margin-top: 40px;" />
      <div class="textarea">
        <h2>Database Owner Login</h2>
        <br></br>
        <form name="login" action="ownerlogin.jsp" method="post" onsubmit="return validate()">
