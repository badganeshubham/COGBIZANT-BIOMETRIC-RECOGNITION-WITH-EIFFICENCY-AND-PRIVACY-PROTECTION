...
<%
            ...
            int n=0;     
             ...
             rs=st.executeQuery("select * from userreg1");
       ...
       <table  align="center" border="10px" cellpadding="10px" cellspacing="0px">
          ...
          <%while(rs.next())
          {
              ...
              <tr>
                  ...
                  <td><textarea rows="5" cols="20" readonly><%=rs.getString(2)%></textarea></td>
                   <td><textarea rows="5" cols="20" readonly><%=rs.getString(3)%></textarea></td>
                    <td><textarea rows="5" cols="20" readonly><%=rs.getString(4)%></textarea></td> 
                     <td><textarea rows="5" cols="20" readonly><%=rs.getString(4)%></textarea></td>
