...
<div class="main">
  <div class="header">
    ...
    <div class="headert_text_resize">
        ...
        <a href="UserReg.jsp"><img src="images/Registration.png" alt="" width="395" height="295" style="margin-top: 40px;" /></a>
      <div class="textarea">
        <h2>User Login</h2>
        ...
        <form name="login" action="Userlogin.jsp" method="post" onsubmit="return validate()">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2>Welcome<br />
          <span> UNVEILING IN-APP ADS AND UNCOVERING COVERT ATTACKS VIA MOBILE APP-WEB INTERFACE</span> </h2>
